...
function send_record($base, $post_id){ 
	...
	$parser->parse($graph, $HTMLmetadata, 'rdfa', $base);

	// here I do something that may seem nonsense: I parse the RDFa and I output RDF for ARC2. This is because I'm not able to get the triples from EasyRDF
